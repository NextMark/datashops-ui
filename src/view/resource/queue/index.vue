    ...
    <div>
        ...
        <el-dialog title="新增" :visible.sync="dialogFormVisible">
            <el-form :model="form" ref="form">
                <el-form-item label="队列名称" label-width="80px" prop="name">
                    <el-input v-model="form.name"></el-input>
                </el-form-item>
                <el-form-item label="队列值" label-width="80px" prop="value">
        ...
        methods: {
            ...
            async enterDialog() {
                this.$refs.form.validate(async valid => {
                    if (valid) {
                        const res = await addQueue(this.form);
                        if (res.code === 1000) {
                            this.$message({
                                type: "success",
                                message: "添加成功!"
