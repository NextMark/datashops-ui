<template>
  <div>
    ...
    <el-table :data="tableData" border row-key="id" stripe>
      <el-table-column label="ID" min-width="70" prop="id"></el-table-column>
      ...
      <el-table-column label="Path" min-width="160" prop="path"></el-table-column>
    ...
    <el-dialog :before-close="handleClose" :title="dialogTitle" :visible.sync="dialogFormVisible">
      <el-form
        ...
        ref="menuForm"
      >
        <el-form-item label="路由" prop="path" style="width:30%">
          <el-input
            @change="changeName"
            autocomplete="off"
            placeholder="唯一英文字符串"
